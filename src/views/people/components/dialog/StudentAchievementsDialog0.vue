  ...
  <div style="display: inline;">
    ...
    <el-dialog :visible.sync="dialogFormVisible" class="dialog">
      <el-form :model="postForm" label-width="200px" label-position="left">
        ...
        <el-form-item label="参与科研项目名称" class="dialog-form-item">
          <el-input v-model="postForm.title" autocomplete="off" />
        </el-form-item>

        <el-form-item label="刊物名称" class="dialog-form-item">
          <el-input v-model="postForm.journal_title" autocomplete="off" />
        </el-form-item>

        <el-form-item label="影响因子" class="dialog-form-item">
          <el-input v-model="postForm.factor" autocomplete="off" />
        </el-form-item>

        <el-form-item label="发表日期" class="dialog-form-item">
          <el-input v-model="postForm.publish_date" autocomplete="off" />
        </el-form-item>

        <el-form-item label="作者排名" class="dialog-form-item">
          <el-input v-model="postForm.author_rank" autocomplete="off" />
        </el-form-item>

        <el-form-item label="收录情况" class="dialog-form-item">
          <el-input v-model="postForm.acceptance" autocomplete="off" />
        </el-form-item>

        <el-form-item label="南科大是第几署名单位" class="dialog-form-item">
          <el-input v-model="postForm.sustech_rank" autocomplete="off" />
        </el-form-item>

        <el-form-item label="论文署名单位是否含境外单位" class="dialog-form-item">
          <el-input v-model="postForm.is_international" autocomplete="off" />
        </el-form-item>

        <el-form-item label="有否提供佐证材料" class="dialog-form-item">
          <el-input v-model="postForm.is_supported" autocomplete="off" />
        </el-form-item>

        <el-form-item label="DOI" class="dialog-form-item">
          <el-input v-model="postForm.doi" autocomplete="off" />
        </el-form-item>
...
export default {
  name: 'StudentAchievementsDialog0',
  ...
  methods: {
    handleSubmit() {
      const finalPostForm = { type: 'paper', data: this.postForm }
      switch (this.type) {
