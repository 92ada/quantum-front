  ...
  <div style="display: inline;">
    ...
    <el-dialog :visible.sync="dialogFormVisible" class="dialog">
      <el-form :model="postForm" label-width="200px" label-position="left">
        ...
        <el-form-item label="项目负责人" class="dialog-form-item">
          <el-input v-model="postForm.leader_name" autocomplete="off" />
        </el-form-item>

        <el-form-item label="项目性质" class="dialog-form-item">
          <el-input v-model="postForm.type" autocomplete="off" />
          <small>指纵向、横向项目</small>
        </el-form-item>

        <el-form-item label="纵向项目类别" class="dialog-form-item">
          <el-input v-model="postForm.col_type" autocomplete="off" />
        </el-form-item>

        <el-form-item label="参与开始时间" class="dialog-form-item">
          <el-input v-model="postForm.start_month" autocomplete="off" />
          <small>输入格式YYYY/MM</small>
        </el-form-item>

        <el-form-item label="参与结束时间" class="dialog-form-item">
          <el-input v-model="postForm.end_month" autocomplete="off" />
          <small>输入格式YYYY/MM</small>
        </el-form-item>
...
export default {
  name: 'StudentAchievementsDialog6',
  ...
  methods: {
    handleSubmit() {
      const finalPostForm = { type: 'research', data: this.postForm }
      switch (this.type) {
