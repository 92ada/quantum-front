<template>
  <div class="app-container">
    ...
    <el-link v-if="type === 'edit'" v-permission="['delete_equipment_'+equipmentType, 'delete_equipment']" icon="el-icon-edit" @click="onDelete" style="margin-left:20px;">{{ $t('common.delete') }}</el-link>
    <el-link v-if="type === 'show'" v-permission="['edit_equipment_'+equipmentType, 'edit_equipment']" icon="el-icon-edit" @click="goToEdit">{{ $t('common.edit') }}</el-link>
